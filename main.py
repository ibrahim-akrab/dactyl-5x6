...
keyboard.keymap = [
    [   #0
        ...
        KC.LCTL, KC.Z,  KC.X,    KC.C,    KC.V,  KC.B,                          KC.N,  KC.M,  KC.COMM, KC.DOT, KC.SLSH, KC.APP,
                        KC.LBRC, KC.RBRC,                                                      KC.MINS, KC.EQL,
                                                KC.MO(2), KC.SPC,      KC.ENT,  KC.MO(1),
                                                KC.CW,    KC.DEL,      KC.BSPC, RSFT,
    ...
    [  #2
        KC.TRNS, KC.F11, KC.F12, KC.NO, KC.NO, KC.NO,                           KC.NO,   KC.NO,   KC.NO, KC.NO,   KC.NO, KC.NO,
        ...
        KC.NO,   KC.NO,  KC.NO,  KC.NO, KC.NO, KC.NO,                           KC.NO,   KC.NO,   KC.NO, KC.NO,   KC.NO, KC.NO,
                         KC.NO,  KC.NO,                                                           KC.NO, KC.NO,
                                                    ...
                                                    KC.TRNS, KC.TRNS,      KC.TRNS, KC.TRNS,
                                                    KC.HOME, KC.END,       KC.TRNS, KC.TRNS
    ],
    [  #3
